let currentVal=0; //ardarda işlem yapılmasını sağlamak için
let result=0;
let isClickSymbol=false;
let isClickNumber=false; //sembollere basıldığında true olacak ona göre işlem yapılacak
let selectSymbol=0;
...
function ClickNumber(val){
    ...
    if(inputVal==0){//inputVal yazan değer
        $('#inputVal').text(val);
    }else{
